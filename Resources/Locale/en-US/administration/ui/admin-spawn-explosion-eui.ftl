...
cmd-explosion-help = Usage: explosion [intensity] [slope] [maxIntensity] [x y] [mapId] [prototypeId] [worldZ]
...
cmd-explosion-failed-to-parse-world-z = Failed to parse world Z-level: {$value}
