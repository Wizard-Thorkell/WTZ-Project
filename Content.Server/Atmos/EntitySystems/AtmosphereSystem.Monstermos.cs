...
namespace Content.Server.Atmos.EntitySystems
{
    public sealed partial class AtmosphereSystem
    {
            ...
            TileAtmosphere other)
        {
            ...
            foreach (var entity in GetAnchoredEntitiesOnAtmosTile(ent.Owner, mapGrid, tile))
            {
            ...
            foreach (var entity in GetAnchoredEntitiesOnAtmosTile(ent.Owner, mapGrid, other))
            {
                if (_firelockQuery.TryGetComponent(entity, out var firelock))
                    reconsiderAdjacent |= _firelockSystem.EmergencyPressureStop(entity, firelock);
            }
