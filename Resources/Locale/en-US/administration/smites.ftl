...
admin-trick-enable-z-level-description = Adds the experimental Z-Level components to the target so it can use DragonStation's layered movement prototype.
admin-trick-disable-z-level-description = Removes the experimental Z-Level components from the target.
admin-trick-z-level-up-description = Moves the target up one experimental Z-Level. Without a support floor there, it will fall back down.
admin-trick-z-level-down-description = Moves the target down one experimental Z-Level. If there is no support below, it may keep falling.
admin-trick-stamp-z-level-above-description = Copies a small patch of the current floor to the Z-Level above the target for quick testing.
admin-trick-stamp-z-level-below-description = Copies a small patch of the current floor to the Z-Level below the target for quick testing.
